...
float RC4::CalculateCPULoad(unsigned long long idleTicks, unsigned long long totalTicks)
{
...
unsigned long long RC4::FileTimeToInt64(const FILETIME& ft)
{
	return (((unsigned long long)(ft.dwHighDateTime)) << 32) | ((unsigned long long)ft.dwLowDateTime);
}

float RC4::GetCPULoad()
{
...
string RC4::getSecuenciabitxbit()
{
	string sec;
	for (string a : Or) {
		sec += a;
